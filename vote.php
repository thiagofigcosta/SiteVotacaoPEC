        ...
        <form action="process.php" method="GET">
            <fieldset>
                ...
                <fieldset id="ContraPec">
                    ...
                    <div id="radio"><input type="radio" value="true" name="ContraPec"> Sim
                    <input type="radio" value="false" name="ContraPec"> Não</div>
                </fieldset>
                <fieldset id="ContraGreve">
                    <legend>Contra Greve?</legend>
                    <div id="radio"><input type="radio" value="true" name="ContraGreve"> Sim
                    <input type="radio" value="false" name="ContraGreve"> Não</div>
                </fieldset>
                <fieldset id="ContraOcupacao">
                    <legend>Contra Ocupacao?</legend>
                    <div id="radio"><input type="radio" value="true" name="ContraOcupacao"> Sim
                    <input type="radio" value="false" name="ContraOcupacao"> Não</div>
                </fieldset>
                Ponderações:
